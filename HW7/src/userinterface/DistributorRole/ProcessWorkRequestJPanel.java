...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public ProcessWorkRequestJPanel(JPanel userProcessContainer, VaccineRequest request) {
        initComponents();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        if (resultJTextField.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Result cannot be empty!", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
